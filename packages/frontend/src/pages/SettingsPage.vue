  ...
  <q-page class="q-pa-md row justify-center">
    <q-card style="width: 500px">
      ...
      <q-card-section class="q-gutter-md">
        ...
        <q-separator />
        <q-toggle v-model="pushEnabled" :label="$t('notifications.enablePush')" :disable="!pushSupported" @update:model-value="togglePush" />
        ...
        <q-btn color="secondary" :label="$t('settings.downloadData')" class="full-width" :loading="exportLoading" @click="handleExport" />
        <q-btn color="warning" :label="$t('settings.suspendAccount')" class="full-width" :loading="suspendLoading" @click="handleSuspend" />
        <q-btn color="negative" :label="$t('settings.deleteAccount')" class="full-width" :loading="deleteLoading" @click="handleDelete" />
        <q-separator />
