    ...
    const wrapper = shallowMount(Page, {
      global: {
        ...
        stubs: {
          ...
          TournamentManageHeader: { template: '<div class="manage-header" />' },
          ParticipantListSection: { template: '<div class="participant-section" />' },
          BracketMatchSection: { template: '<div class="bracket-section" />' },
