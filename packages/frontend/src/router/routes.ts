...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: 'tournaments', name: 'tournaments', component: () => import('@/pages/tournaments/ListPage.vue') },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'tcgs/:id/formats', name: 'admin-tcg-formats', component: () => import('@/pages/admin/FormatListPage.vue') },
      { path: 'stores', name: 'admin-stores', component: () => import('@/pages/admin/StoreManageListPage.vue') },
      { path: 'stores/:id', name: 'admin-store-detail', component: () => import('@/pages/admin/StoreManageDetailPage.vue') },
