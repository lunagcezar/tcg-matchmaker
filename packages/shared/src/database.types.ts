    ...
    Tables: {
      ...
      bracket_matches: {
        Row: {
          ...
          next_match_player_slot: number | null;
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'bracket_matches_round_id_fkey';
            columns: ['round_id'];
            isOneToOne: false;
      ...
      bracket_rounds: {
        ...
        Relationships: [
          {
            foreignKeyName: 'bracket_rounds_event_id_fkey';
            columns: ['event_id'];
            isOneToOne: false;
      ...
      events: {
        Row: {
          ...
          name: string | null;
          organizer_store_id: string | null;
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'events_organizer_store_id_fkey';
            columns: ['organizer_store_id'];
            isOneToOne: false;
            referencedRelation: 'game_stores';
            referencedColumns: ['id'];
          },
          {
          ...
          {
            foreignKeyName: 'events_tcg_id_fkey';
            columns: ['tcg_id'];
            isOneToOne: false;
            referencedRelation: 'tcgs';
            referencedColumns: ['id'];
          },
        ];
      };
      formats: {
        ...
        Relationships: [
          {
            foreignKeyName: 'formats_tcg_id_fkey';
            columns: ['tcg_id'];
            isOneToOne: false;
            referencedRelation: 'tcgs';
            referencedColumns: ['id'];
      ...
      game_stores: {
        ...
        Relationships: [
          {
            foreignKeyName: 'game_stores_created_by_user_id_fkey';
            columns: ['created_by_user_id'];
            isOneToOne: false;
            referencedRelation: 'users';
            referencedColumns: ['id'];
      ...
      store_memberships: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'store_memberships_user_id_fkey';
            columns: ['user_id'];
            isOneToOne: false;
            referencedRelation: 'users';
            referencedColumns: ['id'];
